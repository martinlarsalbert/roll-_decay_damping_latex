...
Fig.{[}(below){]}.(\#fig\_rolldecay\_example)
\begin{figure}[H]
\begin{center}\includegraphics[width = 0.475\textwidth]{figures/output_3_0.pdf}\end{center}
\vspace{-0.7cm}
\caption{}
\label{fig:}
\end{figure}
The oscillating motion can be described by a spring-mass-damper system
as seen in Fig.\href{fig_spring_mass_damper}{(below)}.
\begin{figure}[H]
\begin{center}\includegraphics[width = 0.475\textwidth]{fig:rolldecay_example.png}\end{center}
\vspace{-0.7cm}
\caption{Spring-mass-damper system}
\label{fig:fig:rolldecay_example}
\end{figure}
...
\end{equation}
And cubic stiffness model \citep{7505983/KL7A3RIV}:
\begin{equation}
