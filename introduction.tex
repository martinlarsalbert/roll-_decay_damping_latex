...
\begin{itemize}
\item GitHub: https://github.com/martinlarsalbert/roll_decay_damping
\item Binder: https://mybinder.org/v2/gh/martinlarsalbert/roll_decay_damping/HEAD?filepath=reports%2Freport%2F01.1.report.
\end{itemize}
ipynb
\begin{figure}[H]
