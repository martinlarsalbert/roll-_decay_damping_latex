...
\begin{figure}[H]
\begin{center}\includegraphics[width = 0.475\textwidth]{figures/rolldecay_example.pdf}\end{center}
\vspace{-0.7cm}
...
\begin{figure}[H]
\begin{center}\includegraphics[width = 0.475\textwidth]{figures/spring_mass_damper.png}\end{center}
\vspace{-0.7cm}
